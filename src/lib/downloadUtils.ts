 ...
 */
export async function downloadMultipleFiles(files: DownloadOptions[]): Promise<DownloadResult[]> {
 ...
 */
export function generateSafeFilename(baseName: string, existingNames: string[] = []): string {
